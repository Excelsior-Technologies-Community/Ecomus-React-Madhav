...
export default function Wishlist({ wishlist, removeFromWishlist, addToCart }) {
  const handleAddToCart = (p) => {
    addToCart({ ...p, selectedColor: p.colors?.[0], selectedSize: p.sizes?.[0], qty: 1, images: p.colors?.[0] ? [p.img1] : [] });
  };
              ...
              <div className="product-card">
                <div className="product-img">
                  ...
                  <div className="product-actions">
                    <div className="action-btn" onClick={() => handleAddToCart(p)}>
                      <i className="fa-solid fa-cart-plus"></i>
                    </div>
                    <div className="action-btn" onClick={() => removeFromWishlist(p.id)}>
