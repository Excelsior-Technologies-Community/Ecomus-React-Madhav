    ...
    return (
        ...
        <div className="container-fluid">
            <div className="container">
                <Link to="/" className="no-underline"><span className="px-3 text-black no-underline">Home</span></Link>
                <Link to="/collection" className="no-underline"><span className="px-3 text-black no-underline">Women</span></Link>
            </div>
        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div>
                        ...
                        <div className="mt-8 flex gap-2">
                            <button
                                className="flex-1 bg-black text-white py-2 font-semibold hover:bg-gray-800"
                                onClick={() => {
                                    addToCart({
                                        ...product,
                                        selectedColor,
                            ...
                            <button 
                                className="w-14 border text-xl flex items-center justify-center hover:bg-black hover:text-white transition" 
                        ...
                        <button className="w-full bg-yellow-400 py-2 mt-3 font-bold hover:bg-yellow-500 transition">
                            Buy with PayPal
                        </button>
                    </div>
                </div>
